...
var getGameData = function getGameData() {
  return $.ajax({
    ...
    success: function success(data) {
      ...
      var jsonGameData = JSON.parse(gameData);
      var playerGamesPlayedEl = document.getElementById('playergamesplayed');
...
// the empty gameboard I set it as a empty array
...
var onCreateGame = function onCreateGame() {
  api.createGameApi().then(ui.onCreateGameSuccess).catch(ui.onCreateGameError);
};

var onUpdateGame = function onUpdateGame() {
  api.updateGameApi().then(ui.onUpdateSuccess).catch(ui.onUpdateError);
};
...
var onCreateGameError = function onCreateGameError(error) {
...
module.exports = {
  ...
  onCreateGameError: onCreateGameError,
...
var initGame = function initGame() {
  ...
  for (var i = 0; i < 9; i++) {
    var gameboardSquare = document.createElement('div');
  ...
  // users
  var playerStatusMessage = void 0;
  ...
  var updateStatusMessage = function updateStatusMessage(message) {
  ...
  $('#gameboard > div').on('click', function (event) {
    ...
    var squareLocation = square.match(/\d+/g);
    var squareTarget = '#' + square;
    ...
    var isValid = $(squareTarget).is(':empty');
    if (!isValid) {
    ...
    if (turns >= 5) {
      ...
      for (var combo = 0; combo < winningCombos.length; combo++) {
        ...
        var spot1 = winningCombos[combo].spot1;
        var spot2 = winningCombos[combo].spot2;
        var spot3 = winningCombos[combo].spot3;
        ...
        var square1 = squaresPlayed[spot1];
        var square2 = squaresPlayed[spot2];
        var square3 = squaresPlayed[spot3];
